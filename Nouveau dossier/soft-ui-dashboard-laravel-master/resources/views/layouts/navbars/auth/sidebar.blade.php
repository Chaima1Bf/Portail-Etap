<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            <img style=" " src="../assets/img/etap.png" class="navbar-brand-img h-100"  alt="...">
            <span class="ms-1 font-weight-bold">ETAP</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'user-management' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Peronals</span>
                </a>
            </li>
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold">Contact Us Now</p>
                    <a href="#" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">Contact</a>
                </div>
            </div>
        </div>
    </div>
