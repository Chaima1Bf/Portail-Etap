...
<section class="section">
      ...
      <article class="leaderboard">
        <header>
          ...
          <h1 class="leaderboard__title"><span class="leaderboard__title--top">Signataires</span></h1>
        </header>
...
<style>
 ...
 .leaderboard header {
	 --start: 15%;
	 height: 130px;
	 background-image: repeating-radial-gradient(circle at var(--start), transparent 0%, transparent 10%, #6777ef 10%, rgba(54, 89, 219, .33) 17%), linear-gradient(to right, #6777ef, #3659db);
	 color: #fff;
	 position: relative;
